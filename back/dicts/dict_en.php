...
$DICT_EN->translate(StringIdentifier::SID_ETUDE_H2_4, "Project implementation");
$DICT_EN->translate(StringIdentifier::SID_ETUDE_H2_5, "Amendment if changes are needed");
$DICT_EN->translate(StringIdentifier::SID_ETUDE_H2_6, "Delivery");
$DICT_EN->translate(StringIdentifier::SID_ETUDE_H2_7, "Guarantee");
...
$DICT_EN->translate(StringIdentifier::SID_MISSION,"<br>ETIC INSA Technologies est une Junior-Entreprise, une association loi 1901 à but non lucratif et à vocation pédagogique et économique.</br> Our mission : completing theoretical training provided in our establishment of higher education, INSA Lyon, by practical applications in enterprise. The turnover generated  allows de rémunérer les consultants ayant réalisé l’aspect technique des missions.</p>");
...
$DICT_EN->translate(StringIdentifier::SID_ENGAGEMENT_P_4,"Guaranteed skills of our contributors");
...
$DICT_EN->translate(StringIdentifier::SID_DEVIS_PLANNED_DURATION, "Duration (in weeks, for information)");
...
$DICT_EN->translate(StringIdentifier::SID_ETIC_RSE_P1_DESCRIPTION, "Reinventing ourselves everyday. Being an actor of the future by thinking outside the box, by believing in humanity before believing in technique, by loving technique not for setting up an artificial society but loving it as a mean of attaining progress... ");
$DICT_EN->translate(StringIdentifier::SID_ETIC_RSE_SOUS_TITRE,"Our CSR vision at ETIC");
$DICT_EN->translate(StringIdentifier::SID_ETIC_RSE_AUTEUR_DATE, "By the Executive Board| November 22, 2018");
$DICT_EN->translate(StringIdentifier::SID_ETIC_RSE_P1, "Reinventing ourselves everyday. Being an actor of the future by thinking outside the box, by believing in humanity before believing in technique, by loving technique not for setting up an artificial society but loving it as a mean of attaining progress. By always staying humble towards science but promising to work at our own pace without ever resigning ourselves. Here is the incredible legacy the founder of INSA, Gaston Berger, left us with. More than an aspiration, this is a moral duty towards society he entrusted us with. Prospective and Humanism. Two words for a single model. «Prospective» as in preparing the future, «Humanism» in order to never forget that the only thing that deserves to be at the heart of the system is humanity ");
$DICT_EN->translate(StringIdentifier::SID_ETIC_RSE_P2, " Without having the boldness to consider this wisdom taken for granted, the values of Gaston Berger are written in our DNA of INSA engineers. Our education and our lives at INSA taught us to learn, to challenge and to share this philosophy in order to build tomorrow’s world. However, if we are diverse engaged engineers in our studies, we are so as people too, on a daily basis, in our actions and our projects. ");
$DICT_EN->translate(StringIdentifier::SID_ETIC_RSE_P3,  "ETIC INSA Technologies built itself on this model, collectively, with boldness and humility and has made the most of every mandate since 1981. From this, has emerged a remarkable richness in our process as well as a our will for a certain quality and benevolence towards all our stakeholders. We believe in CSR (Corporate Social Responsibility) and we want to be a part of it : ETIC INSA Technologies is a humanist Junior Enterprise.");
$DICT_EN->translate(StringIdentifier::SID_ETIC_RSE_P4,  "Therefore this year we chose to develop our own CSR Management System. We also chose not to audit our process by an outside agency because this is a substantial financial investment, which is not relevant  for our structure at the moment. On one side,  we have a free access to all ISO standard and to CSR qualified people  thanks to the Gaston Berger Institute which is a structure in charge of guaranteeing, projecting and promoting the INSA model. On the other hand, we prefer to make our successors mindful of social and environmental issues so that whether or not our process will be carried on, it will be a personal choice and not a duty, preventing in this way potential abuses towards Green Washing actions.");
$DICT_EN->translate(StringIdentifier::SID_ETIC_RSE_P5,    " <div class=\"row\">
            <div class=\"ui center aligned article-subtitle\">
                <bold class=\"centered\">Actions implemented and areas of work</bold>
            </div>
...
$DICT_EN->translate(StringIdentifier::SID_FIMITECH_P2, "Halfway between a free access workshop and a practical training room, now students have the opportunity to develop their projects under the inspection and the guidance of  about twenty specialist teachers. Therefore, this unique platform in the region is a great means to comprehend the technical aspect of the engineering job through pedagogical projects, whether personal or associative.");
$DICT_EN->translate(StringIdentifier::SID_FIMITECH_P3, "It is precisely in this context that ETIC has naturally decided to get closer to this workshop in order to have access to various methods of technical production for the upcoming  studies. The opening of this facility to students makes the widening of  our area of expertise possible through the use of specific machinery (3D printing, metal construction and finally mecatronics).  Being accompanied by experts is twice beneficial as well ; this increases the educational dimension of our projects for the consultants but also enables us to provide to our clients a quality deliverable, approved by the teaching staff.
");
$DICT_EN->translate(StringIdentifier::SID_FIMITECH_P4, "Moreover, as ETIC is one of the few Junior Enterprise to have at our disposal professional licences of CAD (Computer Aided Design)  permitting the realisation of design/simulation  studies. From now on we can offer comprehensive study to our clients. Indeed, from initial computer design to prototype production, INSA Lyon students will now be able to materialize projects even more qualifying for our clients by being consultant at ETIC.");
$DICT_EN->translate(StringIdentifier::SID_FIMITECH_RESUME, "Since its official opening on Thursday 14th February, the technical production workshop of INSA Lyon named « FIMITECH » now enables all students of the school...");
