...
class StringIdentifier {
    ...
    const SID_PARTENAIRES_ICF = "{PARTENAIRES_ICF}";
    ...
    const SID_PARTENAIRES_ICF_TEXT = "{PARTENAIRES_ICF_TEXT}";
    ...
    const SID_CARACTERISATION_THERMIQUE = "{CARACTERISATION_THERMIQUE}";
    const SID_CARACTERISATION_THERMIQUE_AUTEUR = "{CARACTERISATION_THERMIQUE_AUTEUR}";
    const SID_CARACTERISATION_THERMIQUE_P1 = "{CARACTERISATION_THERMIQUE_P1}";
    const SID_CARACTERISATION_THERMIQUE_P2 = "{CARACTERISATION_THERMIQUE_P2}";
    const SID_CARACTERISATION_THERMIQUE_P3 ="{CARACTERISATION_THERMIQUE_P3}";
    const SID_CARACTERISATION_THERMIQUE_FIGURE1 ="{CARACTERISATION_THERMIQUE_FIGURE1}";
    const SID_CARACTERISATION_THERMIQUE_P4 = "{CARACTERISATION_THERMIQUE_P4}";
    const SID_CARACTERISATION_THERMIQUE_FIGURE2 = "{CARACTERISATION_THERMIQUE_FIGURE2}";
    ...
    // article sur la Caracterisation_thermique
    const SID_ANCIEN_SECTION = "{ANCIEN_SECTION}";
    const SID_ANCIEN = "{ANCIEN}";
    const SID_ANCIEN_AUTEUR = "{ANCIEN_AUTEUR}";
    const SID_ANCIEN_P1 = "{ANCIEN_P1}";
    ...
    const SID_TEMOIGNAGE_ANCIEN_AUTEUR = "{TEMOIGNAGE_ANCIEN_AUTEUR}";
    const SID_TEMOIGNAGE_ANCIEN_P1 = "{TEMOIGNAGE_ANCIEN_P1}";
    const SID_TEMOIGNAGE_ANCIEN_Q1 = "{TEMOIGNAGE_ANCIEN_Q1}";
    const SID_TEMOIGNAGE_ANCIEN_R1 ="{TEMOIGNAGE_ANCIEN_R1}";
    const SID_TEMOIGNAGE_ANCIEN_Q2 = "{TEMOIGNAGE_ANCIEN_Q2}";
    const SID_TEMOIGNAGE_ANCIEN_R2 ="{TEMOIGNAGE_ANCIEN_R2}";
    const SID_TEMOIGNAGE_ANCIEN_Q3 = "{TEMOIGNAGE_ANCIEN_Q3}";
    const SID_TEMOIGNAGE_ANCIEN_R3 = "{TEMOIGNAGE_ANCIEN_R3}";
    const SID_TEMOIGNAGE_ANCIEN_Q4 = "{TEMOIGNAGE_ANCIEN_Q4}";
    const SID_TEMOIGNAGE_ANCIEN_R4 = "{TEMOIGNAGE_ANCIEN_R4}";
    const SID_TEMOIGNAGE_ANCIEN_Q5 ="{TEMOIGNAGE_ANCIEN_Q5}";
    const SID_TEMOIGNAGE_ANCIEN_R5 = "{TEMOIGNAGE_ANCIEN_R5}";
    const SID_TEMOIGNAGE_ANCIEN_Q6 ="{TEMOIGNAGE_ANCIEN_Q6}";
    const SID_TEMOIGNAGE_ANCIEN_R6 ="{TEMOIGNAGE_ANCIEN_R6}";
    const SID_TEMOIGNAGE_ANCIEN_Q7 = "{TEMOIGNAGE_ANCIEN_Q7}";
    const SID_TEMOIGNAGE_ANCIEN_R7 = "{TEMOIGNAGE_ANCIEN_R7}";
    const SID_TEMOIGNAGE_ANCIEN_AUTEUR2 = "{TEMOIGNAGE_ANCIEN_AUTEUR2}";
    const SID_TEMOIGNAGE_ANCIEN_VISION = "{TEMOIGNAGE_ANCIEN_VISION}";
	...
	const SIDS = array(
        ...
        StringIdentifier::SID_PARTENAIRES_ICF,
        ...
        StringIdentifier::SID_PARTENAIRES_ICF_TEXT,
        ...
        // ARTICLE CARACTERISATION_THERMIQUE
        StringIdentifier::SID_CARACTERISATION_THERMIQUE,
        StringIdentifier::SID_CARACTERISATION_THERMIQUE_SECTION,
        StringIdentifier::SID_CARACTERISATION_THERMIQUE_AUTEUR,
        StringIdentifier::SID_CARACTERISATION_THERMIQUE_P1,
        StringIdentifier::SID_CARACTERISATION_THERMIQUE_P2 ,
        StringIdentifier::SID_CARACTERISATION_THERMIQUE_P3,
        StringIdentifier::SID_CARACTERISATION_THERMIQUE_FIGURE1,
        StringIdentifier::SID_CARACTERISATION_THERMIQUE_P4,
        StringIdentifier::SID_CARACTERISATION_THERMIQUE_FIGURE2,
        ...
        //ARTCLE ANCIEN
        StringIdentifier::SID_ANCIEN_SECTION,
        StringIdentifier::SID_ANCIEN,
        StringIdentifier::SID_ANCIEN_AUTEUR,
        StringIdentifier::SID_ANCIEN_P1,
        ...
        StringIdentifier::SID_TEMOIGNAGE_ANCIEN_AUTEUR ,
        StringIdentifier::SID_TEMOIGNAGE_ANCIEN_P1,
        StringIdentifier::SID_TEMOIGNAGE_ANCIEN_Q1 ,
        StringIdentifier::SID_TEMOIGNAGE_ANCIEN_R1 ,
        StringIdentifier::SID_TEMOIGNAGE_ANCIEN_Q2,
        StringIdentifier::SID_TEMOIGNAGE_ANCIEN_R2,
        StringIdentifier::SID_TEMOIGNAGE_ANCIEN_Q3 ,
        StringIdentifier::SID_TEMOIGNAGE_ANCIEN_R3,
        StringIdentifier::SID_TEMOIGNAGE_ANCIEN_Q4,
        StringIdentifier::SID_TEMOIGNAGE_ANCIEN_R4,
        StringIdentifier::SID_TEMOIGNAGE_ANCIEN_Q5 ,
        StringIdentifier::SID_TEMOIGNAGE_ANCIEN_R5,
        StringIdentifier::SID_TEMOIGNAGE_ANCIEN_Q6 ,
        StringIdentifier::SID_TEMOIGNAGE_ANCIEN_R6,
        StringIdentifier::SID_TEMOIGNAGE_ANCIEN_Q7,
        StringIdentifier::SID_TEMOIGNAGE_ANCIEN_R7,
        StringIdentifier::SID_TEMOIGNAGE_ANCIEN_AUTEUR2,
        StringIdentifier::SID_TEMOIGNAGE_ANCIEN_VISION ,
    ...
    const LINK_ARTIClE_12 = "{LINK_ARTICLE_12}"; // fimitech
	...
	const LINKS = array(
        ...
        StringIdentifier::LINK_ARTIClE_12,
